    ...
    <!-- //inner banner -->
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="title-heading-w3 text-center mx-auto mb-sm-5 mb-4" style="max-width:700px">
                <h3 class="title-style">Create your account here</h3>
            </div>
                ...
                <div class="row contact-block">
                    ...
                    <div class="col-md-7 contact-right mt-md-0 mt-4">
                        <form action="https://sendmail.w3layouts.com/submitForm" method="post" class="signin-form">
                            ...
                            <button class="btn btn-style btn-style-primary-2">Submit</button>
                            <b><a href="#">Forget Password</a></b>
                            <h4>Have an account  <a href="login.php">Log in Your Account</a></h4>
                        </form>
                    </div>
                </div>
            </div>
